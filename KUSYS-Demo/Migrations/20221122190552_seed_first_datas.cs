...
{
    public partial class seed_first_datas : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoursesStudents", x => new { x.Id, x.CourseId });
                    table.ForeignKey(
                        name: "FK_CoursesStudents_AspNetUsers_Id",
                        column: x => x.Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "02174cf0–9412–4cfe-afbf-59f706d72cf6", 0, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "fa0f0475-91ab-4d0b-afe4-edf1f1b0a3a1", "canan@gmail.com", true, "Canan", "Sağlam", false, null, null, "CANAN@GMAIL.COM", "AQAAAAEAACcQAAAAEK2tdrmzbkXULlXcq8MQk75ScLKEZe/ypw720SKOajAkAAI1vXY2XFzzKs7nO9a0Hw==", null, false, "1fe3e38c-a4ae-421e-99cd-1d697b7dab6a", false, "canan@gmail.com" });
